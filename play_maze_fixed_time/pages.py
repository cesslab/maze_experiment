...
class Instructions(Page):
    ...
    def vars_for_template(self):
        maze_ids = []
        for lottery_pair in self.participant.vars['preferred_lottery_collection']:
...
class MazePage(Page):
    ...
    def vars_for_template(self):
        lottery_pair = self.participant.vars['preferred_lottery_collection'][self.round_number - 1]
